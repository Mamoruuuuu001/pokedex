...
function Modal({onClick, id, name, image, type, height, weight, stats, statsName}) {
  return (
    <div style={{display:"flex",position:"fixed",top:"0",left:"0",zIndex:"10",width:"100%",height:"100%",alignItems:"center",justifyContent:"space-evenly",background:`linear-gradient(115deg,#fff1ff 48%,#f3533b 48% 55%, #fb7248 55%)`,backgroundRepeat:"no-repeat",backgroundSize:"cover",
